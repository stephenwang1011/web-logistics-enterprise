 ...
 * 
 * @author xy-incito-wk
 *@Description 测试用例：找货源——只填写最大重量
 */
public class FindGoodsPage_611_PrivateGoods_Enterprise_ValidMaxWeightData_Test extends BaseParpare {
	@Test(dataProvider = "data")
	public void ValidMaxWeightData(ITestContext context, Map<String, String> data) {
