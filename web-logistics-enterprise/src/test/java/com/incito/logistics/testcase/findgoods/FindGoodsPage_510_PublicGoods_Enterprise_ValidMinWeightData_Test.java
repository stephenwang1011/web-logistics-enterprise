 ...
 * 
 * @author xy-incito-wk
 *@Description 测试用例：找货源——只填写最小重量
 */
public class FindGoodsPage_510_PublicGoods_Enterprise_ValidMinWeightData_Test extends BaseParpare {
	@Test(dataProvider = "data")
	public void FindGoodsPagePublicGoodsValidMinWeightData(ITestContext context, Map<String, String> data) {
