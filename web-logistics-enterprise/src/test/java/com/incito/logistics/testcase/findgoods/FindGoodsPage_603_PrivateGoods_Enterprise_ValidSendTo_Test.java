 ...
 */
public class FindGoodsPage_603_PrivateGoods_Enterprise_ValidSendTo_Test extends BaseParpare {
	@Test(dataProvider = "data")
	public void ValidSendTo(ITestContext context, Map<String, String> data) {
