 ...
 */
public class FindGoodsPage_509_PublicGoods_Enterprise_ValidGoodsName_Test extends BaseParpare {
	@Test(dataProvider = "data")
	public void FindGoodsPagePublicGoodsValidGoodsName(ITestContext context, Map<String, String> data) {
		...
		FindGoodsPageHelper.checkGoodsName(seleniumUtil, FindGoodsPage.FGP_SECOND_INFO, FindGoodsPage.FGP_SECOND_INFO_CAR_LENGTH,
				data.get("FGP_INPUT_GOODSNAME"));
	}
