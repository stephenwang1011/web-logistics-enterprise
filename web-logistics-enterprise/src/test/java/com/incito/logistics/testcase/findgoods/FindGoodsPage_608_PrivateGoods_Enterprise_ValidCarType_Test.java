 ...
 */
public class FindGoodsPage_608_PrivateGoods_Enterprise_ValidCarType_Test extends BaseParpare {
	@Test(dataProvider = "data")
	public void ValidCarType(ITestContext context, Map<String, String> data) {
