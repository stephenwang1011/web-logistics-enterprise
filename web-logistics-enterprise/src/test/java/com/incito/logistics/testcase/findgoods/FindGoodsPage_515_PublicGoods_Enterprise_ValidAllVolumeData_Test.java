 ...
 * 
 * @author xy-incito-wk
 *@Description 测试用例：找货源——填写最小体积和最大体积
 */
public class FindGoodsPage_515_PublicGoods_Enterprise_ValidAllVolumeData_Test extends BaseParpare {
	@Test(dataProvider = "data")
	public void FindGoodsPagePublicGoodsValidMaxVolumeData(ITestContext context, Map<String, String> data) {
