 ...
 */
public class FindGoodsPage_605_PrivateGoods_Enterprise_ValidMinCarLong_Test extends BaseParpare {
	@Test(dataProvider = "data")
	public void ValidMinCarLong(ITestContext context, Map<String, String> data) {
