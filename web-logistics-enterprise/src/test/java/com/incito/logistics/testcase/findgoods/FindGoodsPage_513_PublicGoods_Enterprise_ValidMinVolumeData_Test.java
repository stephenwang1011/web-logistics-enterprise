 ...
 * 
 * @author xy-incito-wk
 *@Description 测试用例：找货源——只填写最小体积
 */
public class FindGoodsPage_513_PublicGoods_Enterprise_ValidMinVolumeData_Test extends BaseParpare {
	@Test(dataProvider = "data")
	public void FindGoodsPagePublicGoodsValidMinVolumeData(ITestContext context, Map<String, String> data) {
