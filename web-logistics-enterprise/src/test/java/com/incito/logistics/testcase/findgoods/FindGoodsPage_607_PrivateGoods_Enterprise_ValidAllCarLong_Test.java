 ...
 */
public class FindGoodsPage_607_PrivateGoods_Enterprise_ValidAllCarLong_Test extends BaseParpare {
	@Test(dataProvider = "data")
	public void ValidAllCarLong(ITestContext context, Map<String, String> data) {
