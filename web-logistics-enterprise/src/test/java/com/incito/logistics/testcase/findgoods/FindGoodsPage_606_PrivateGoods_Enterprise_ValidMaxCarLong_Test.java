 ...
 */
public class FindGoodsPage_606_PrivateGoods_Enterprise_ValidMaxCarLong_Test extends BaseParpare {
	@Test(dataProvider = "data")
	public void ValidMaxCarLong(ITestContext context, Map<String, String> data) {
