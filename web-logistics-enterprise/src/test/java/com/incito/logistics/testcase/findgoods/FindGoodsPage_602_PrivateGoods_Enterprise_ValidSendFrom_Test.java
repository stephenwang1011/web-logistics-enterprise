 ...
 */
public class FindGoodsPage_602_PrivateGoods_Enterprise_ValidSendFrom_Test extends BaseParpare {
	@Test(dataProvider = "data")
	public void ValidSendFrom(ITestContext context, Map<String, String> data) {
